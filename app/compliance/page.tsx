        ...
        <main className="min-h-screen bg-white">
            ...
            <div className="pt-32 pb-20 px-6 max-w-4xl mx-auto text-gray-800">
                ...
                <div className="mb-8 mt-8 flex items-baseline gap-3">
                    <h1 className="font-holiday text-6xl text-yellow-500">Compliance</h1>
                    <span className="text-3xl text-yellow-400 italic font-light font-rubik">Legal & Regulatory</span>
                </div>
